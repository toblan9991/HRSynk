...
const MobileContractDataDirectory = ({ searchQuery, filterStatus }) => {
  ...
  const contractData = employees.filter(({ jobType, name, status }) => {
    return (
      jobType === "contractor" &&
...
export default MobileContractDataDirectory;
