...
export default function JobDetailsForm({
  ...
  const departmentOptions = Array.isArray(departments)
   ...
   const handleBlur = (field) => {
     ...
     } else if (field === "managerEmail" && !validateEmail(formData.managerEmail)) {
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={6}>
            <FormControl fullWidth variant="outlined">
              <InputLabel id="workSchedule">Work Schedule</InputLabel>
              <Select
          ...
          <Grid item xs={6}>
            <FormControl
              ...
              variant="outlined"
            >
              <InputLabel id="payPeriod-label">Salary Term</InputLabel>
              <Select
